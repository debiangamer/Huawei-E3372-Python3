...
def main():
    ...
    parser.add_argument('host', nargs='?', default='192.168.8.1', help='The hostname / IP address your E5332 is reachable at')
    ...
    if args.tree:
        ...
        if args.format == 'text':
            for prop, val in fp:
                ...
                if prop == "device_information_workmode" and val == "WCDMA":
                    subprocess.run(['notify-send', 'NO LTE, USING 3G'])
